...
export class Booking extends React.Component {
  ...
  //  checking invalid date function
  ...
  render() {
    ...
    return (
      <div className='booking'>
        <ToastContainer />
        <h3 className='booking-price'>SLL {rental.dailyRate} <span className='booking-per-night'>per night</span></h3>
        <hr></hr>
        <div className='form-group'>
          <label htmlFor='dates'>Dates</label>
          <DateRangePicker
            onApply={this.handleApplyDate}
            isInvalidDate={this.checkInvalidDates} opens='left'
            containerStyles={{ display: 'block' }}>
            <input ref={this.dateRef} id='date' type='text' className='form-control'></input>
          </DateRangePicker>
        </div>
        <div className='form-group'>
          ...
          <input
            ...
            id='guests' aria-describedby='guests' placeholder=''></input>
        </div>
        <button
